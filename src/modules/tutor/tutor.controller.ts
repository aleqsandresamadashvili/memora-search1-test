...
import { TutorProfileSetupStep1, TutorProfileSetupStep2 } from '../../types/index.js';

const prisma = new PrismaClient();

export class TutorController {
  static async setupProfileStep1(req: Request, res: Response): Promise<void> {
    try {
      const user = (req as any).user;
      const { firstName, lastName, phone, dob }: TutorProfileSetupStep1 = req.body;
  ...
  static async setupProfileStep2(req: Request, res: Response): Promise<void> {
    try {
      const user = (req as any).user;
      const { subjects, lessonTypes, travelAreas }: TutorProfileSetupStep2 = req.body;
